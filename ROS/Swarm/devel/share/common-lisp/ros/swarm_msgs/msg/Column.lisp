...
(cl:defclass <Column> (roslisp-msg-protocol:ros-message)
  ((row
    :reader row
    :initarg :row
    :type (cl:vector swarm_msgs-msg:Square)
   :initform (cl:make-array 10 :element-type 'swarm_msgs-msg:Square :initial-element (cl:make-instance 'swarm_msgs-msg:Square))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Column>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Column)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name swarm_msgs-msg:<Column> is deprecated: use swarm_msgs-msg:Column instead.")))

(cl:ensure-generic-function 'row-val :lambda-list '(m))
(cl:defmethod row-val ((m <Column>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader swarm_msgs-msg:row-val is deprecated.  Use swarm_msgs-msg:row instead.")
  (row m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Column>) istream)
  ...
  (cl:setf (cl:slot-value msg 'row) (cl:make-array 10))
  (cl:let ((vals (cl:slot-value msg 'row)))
    (cl:dotimes (i 10)
    (cl:setf (cl:aref vals i) (cl:make-instance 'swarm_msgs-msg:Square))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Column>)))
  ...
  "67820cc83c22bec62d23e6552a65e66b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Column)))
  "Returns md5sum for a message object of type 'Column"
  "67820cc83c22bec62d23e6552a65e66b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Column>)))
  ...
  (cl:format cl:nil "Square[10] row~%================================================================================~%MSG: swarm_msgs/Square~%int8[5] pheromones~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Column)))
  "Returns full string definition for message of type 'Column"
  (cl:format cl:nil "Square[10] row~%================================================================================~%MSG: swarm_msgs/Square~%int8[5] pheromones~%~%"))
